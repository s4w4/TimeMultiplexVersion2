...
public class MessageManagerTest2 {
	...
	public void testSyncMessagesReceivedTimeHandleKollisionSetCorrection1()
		...
		assertEquals(clockManager.getCorrectedSendingSlot(mOld1) + 2,
				clockManager.getCorrectedSendingSlot(m1));
		assertEquals(clockManager.getCorrectedSendingSlot(mOld2) + 2,
				clockManager.getCorrectedSendingSlot(m2));
		assertEquals(clockManager.getCorrectedSendingSlot(mOld3) + 2,
				clockManager.getCorrectedSendingSlot(m3));
	}

	// @Test
	// public void testSyncMessagesReceivedTimeHandleOldFrame_Slot_25_1()
	// throws InterruptedException {
